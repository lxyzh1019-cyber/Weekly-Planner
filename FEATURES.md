...
- ⚠ Known, not changed here: an empty day's canvas is drawn 6am–2pm (`dayDrawnSpanMin` counts blocks, not pending invites), so an afternoon invite's ghost on an otherwise empty day is not drawn until the evening is opened. The inbox still shows it.
