...
| What | Standard |
|---|---|
| Morning routine | Teeth + face, 10 minutes. **Set your own timer.** |
| Evening routine | Done before bed, on time |
| Bag + gear | Packed the night before |
| **Personal chores** | Your room, your bed, your things, your school bag. **These are yours. They are never paid.** |
| **First 2 household chores each week** | **You pick which two.** They belong to the family — nobody gets paid to be part of this house. |
...
You pick your two free ones from the chore pool at Sunday. **Every chore in that pool is worth about the same effort**, so there's no clever pick — choose whichever you like and get on with it.

| Result | Pay |
|---|---|
| On time **and** to standard | **$3** |
| To standard, but late | **$2** |
| Not to standard → **redo it**, then to standard | **$1** |
| Not done, or fails the redo | **$0** |

**"On time" is written on the chore itself.** Dishes have a different deadline than laundry, and laundry has a different deadline than taking the bins out. Each chore carries its own — check the card, not the clock.

Maximum **$3 per day.** Anything past that earns **XP instead of money** *(Part 6).*
...
|---|---|
| Swim — per point | **$1** |
| Qualify for Provincials | **+$20** |
| Provincials — per point | **$2** |
| Skating — per point | **$1** |
| Skating placement — in your group (1st/2nd/3rd) | **$20 / $10 / $5** |
| Skating placement — overall (1st/2nd/3rd) | **$20 / $10 / $5** |
| Dance STAR 5 — Silver / Gold per item | **$1 / $2** |
| Dance — all Gold | **+$10** *(dance test max $30)* |

Both skating placements can stack. **No cap on points.**

**Who decides: the official results sheet. Not Mom, not Dad, not you.**

> **One rule, and it never bends: we do not talk about money before or during a competition.**
...
Your sport costs a lot. You borrow 10% of it from Dad — and you pay it back.

| | Jenn | Jess |
|---|---|---|
| Your loan this season | **$1,000** | **$800** |
| Down payment — **Oct 1** | $300 | $240 |
| Each month after (10 months) | $70 | $56 |

### LOAN TERMS

| | |
|---|---|
| Pay on schedule | **No interest. Ever.** |
| Miss a payment | **5% per month, simple interest**, on the part you still owe |
| Pay extra, any amount, any time | **10% comes off whatever you pay early** |

**Simple interest** means the 5% is charged on what you owe — it never charges interest on the interest.

**Pay early and every dollar counts.** Put $100 in early and it clears $110 of your loan. You don't have to wait until you can pay the whole thing off — **any early payment, any size, earns the 10%.**
...
1. **Pay what you've got** — the rest becomes overdue and starts earning 5%.
2. **Pay nothing this month** — the whole payment becomes overdue. Costs more.
3. **Cover it from savings** — pull the difference from your savings or a GIC. No interest charged, but you give up what that money was earning.

Three real options with three different prices. **Your call, at Sunday.**

**Anything above the minimum is yours to decide** — pay the loan down faster, put it in savings, or invest it.

> Your savings account pays interest. Your loan does not. Paying early is a **guaranteed 10%.** Investing might beat that — or might not. **That's your decision to make, and it's a real one.**

Recalculated every season.
...
| What | XP |
|---|---|
| Extra household chore, past your $3 day | **20** |
| Personal chore done without being asked | **10** |
| Learning game / app level cleared | **20** |
| Helping your sister with something that isn't yours | **15** |
| Full 7-day routine streak | **50** |
| Personal best at a competition | **50** |

**100 XP = one level.** Levels don't convert to money and they never expire.

🐣 Newbie · 🐤 Junior · 🦊 Brave · 🦁 Mighty · 🦄 Legendary · 🌟 Star Hero
